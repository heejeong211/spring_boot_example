package com.test.ex.controller;
...
import com.test.ex.service.BoardService;
...
public class BoardRestController {
	...
	public HashMap<Integer, Object> content_view(Model model, @PathVariable("b_no") int b_no) throws Exception{
		
		System.out.println("content_view");
		
		return boardService.selectBoardOne(b_no);
	}
